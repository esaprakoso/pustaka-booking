...
class Buku extends CI_Controller {
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($id_buku) {
                $this->ModelBuku->updateBuku($data,['id'=>$id_buku]);
            }else{
    ...
    public function kategori()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if($id_kategori){
                $this->ModelBuku->updateKategori(['id_kategori'=>$id_kategori],$data);
            }else{
    ...
    // {
        ...
        // $config['max_width'] = '1024';
        // $config['max_height'] = '1000';
        // $config['file_name'] = 'img' . time();//memuat atau memanggil library upload
        // $this->load->library('upload', $config);
        // if ($this->form_validation->run() == false) {
        //     $this->load->view('templates/header', $data);
        //     $this->load->view('templates/sidebar', $data);
    ...
    {
        $dataBuku = $this->ModelBuku->bukuWhere(['id'=>$id_buku])->row();
